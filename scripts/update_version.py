...
def main():
  ...
  plistpath = scriptpath + "/resources/VaiaOneBitPlus-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VaiaOneBitPlus-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VaiaOneBitPlus-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VaiaOneBitPlus-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VaiaOneBitPlus-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/VaiaOneBitPlus.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/VaiaOneBitPlus.iss",inplace=1):
