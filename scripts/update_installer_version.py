...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=VaiaOneBitPlus Demo Installer\n"
      else:
        line="OutputBaseFilename=VaiaOneBitPlus Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the VaiaOneBitPlus Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the VaiaOneBitPlus installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=VaiaOneBitPlus Demo installer\n"
     else:
       line="SetupWindowTitle=VaiaOneBitPlus installer\n"
